...
- [ ] T024 [US2] Edit the generated `db/migrate/TIMESTAMP_create_categories.rb` — change `t.string :name` to `t.string :name, null: false`; ensure `t.references :user` has `null: false, foreign_key: true`; add `add_index :categories, [:user_id, :name], unique: true` before the final `end`
